...
public class GhidraMCPPlugin extends Plugin {
    ...
    private String disassembleFunction(String addressStr) {
        ...
        try {
            ...
            while (instructions.hasNext()) {
                ...
                String comment = listing.getComment(CommentType.POST, instr.getAddress());
    ...
    /**
     * Set a comment using the specified comment type (PLATE_COMMENT or POST_COMMENT)
     */
    ...
    private boolean setDecompilerComment(String addressStr, String comment) {
        return setCommentAtAddress(addressStr, comment, CommentType.PLATE, "Set decompiler comment");
    }
    ...
    private boolean setDisassemblyComment(String addressStr, String comment) {
        return setCommentAtAddress(addressStr, comment, CommentType.POST, "Set disassembly comment");
    }
